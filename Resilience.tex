...
\HugeQuote{JP_STAND}{Fall seven times}{,\newline
stand eight.}{Japanese Proverb}{MA_PERSIST2}{}
...
%%%%%%%%%%%%%
%TODO: position ? 
\hugeQuote{MA_CONTROL2}{We control our own actions}{ and are responsible for them. If we act badly we have harmed ourselves.}{Marcus Aurelius}{}{}
...
\smallQuote{DLP_DNA}{You don't need their approval.}{Danielle La Porte}{}{}
...
\smallQuote{MM_TAKE}{The outside world can take nothing from you 
and cannot unhinge you, as long as you do not allow yourself to 
be disturbed.\newline
The events of your time remain impotent before you 
as long as you refuse to take part.}{Michel de Montaigne}{}{}
...
% todo location ? 
%\smallQuote{MA_STR}{Straight not straightened.}{Marcus Aurelius}{}{}
...
%\hugeQuote{H_TRAVEL}{It is reason and wisdom which take away cares}{ not places affording views over the sea.}{Horace}{}{}
...
\HugeQuote{MR_UTU}{If you work hard to do what is right}{, do not be upset by roadblocks; think about how many of the things in your life haven't turned out as you wanted them to but as they should have done.}{Musonius Rufus}{} 

\HugeQuote{RH_EFFORT}{You control the effort}{ not the results.}{Ryan Holiday}{}{}

\HugeQuote{C_DRAG}{Fate guides the willing}{,\newline
but drags the unwilling.}{Cleanthes}{}{}
...
\vspace*{\fill}\cleartorightpage\vspace*{\fill}
...
%TODO: update ? 
\cleartoleftpage
\HugeQuote{RH_ENDURE}{See things for what they are,}{ do what we can, endure what we must.}{Ryan Holiday}{}{} % similar to schopenhauer
...
\hugeQuote{RLS_QUIET}{Quiet minds cannot be perplexed}{ or frightened but go on like a clock in a thunderstorm.}{Robert Louis Stephenson}{}{}
\vspace*{\fill}
% todo review location
% \hugeQuote{JJ_WORK}{Take a canvas}{. Put a mark on it. Put another mark on it.}{Jasper Johns}{}{}

% todo review for location. 
%\hugeQuote{SL_FAIL}{We give up not simply because events are difficult, but because we hadn’t expected them to be so.}{School of Life}{}{notes on how to keep going\llink{http://www.thebookoflife.org/how-knowledge-of-difficulties-lends-confidence/}}

\cleartorightpage
\HugeQuote{CC_WORK}{Inspiration is for amateurs}{; the rest of us just show up and get to work.}{Chuck Close}{}{}
...
\hugeQuote{MA_PERSIST2}{Disgraceful}{ for the soul to give up while the body is still going strong.}{Marcus Aurelius}{}{}\vspace*{\fill}
\cleartorightpage
\HugeQuote{LT_ENDURE}{Don't cling to your body's woes}{. Then you can learn endurance.}{Lao Tzu}{}
...
\vspace*{\fill}
\cleartorightpage
\HugeQuote{JKZ_ENDURE}{You can't stop the waves}{ but you can learn how to surf.}{Jon Kabat-Zinn}{H_CHANGE}{}

%% Solitude
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cleartoleftpage
\vspace*{\fill}
\smallQuote{JKZ_TYA}{Wherever you go, there you are.}{Jon Kabat-Zinn}{}

\smallQuote{AS_ALONE}{The more a man has in himself,\newline
the less others can be to him.}{Arthur Schopenhauer}{} 
...
%\smallQuote{LT_CH}{He who conquers others is strong.\newline
%He who conquers himself is mighty.}{Lao Tzu}{}{} % todo update quote from my edition

\smallQuote{LT_KTS}{Knowing others is intelligent.\newline
Knowing yourself is enlightened.}{Lao Tzu}{}
\vspace*{\fill}
\cleartorightpage
\HugeQuote{A_ALONE}{Happiness depends on}{\newline
ourselves.}{Aristotle}{}{}
...
\cleartoleftpage
\vspace*{\fill}
\smallQuote{OS_OPTIMISM}{Optimism is cowardice.}{Oswald Spengler}{}
...
\HugeQuote{HOPE}{Hope is a poor hedge.}{}{Erik R. Sirri}{}{
%2007, but likely earlier
We need some hope to keep us going but without a look at what pitfalls are waiting for us we'll be lucky to get through in one piece\llink{http://woopmylife.org}.
}
