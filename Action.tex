...
\HugeQuote{BD_ACT}{Action}{ may not always bring happiness, but without action there is none.}{Benjamin Disraelli}{}

%\hugeQuote{MG_ACT}{You may never know}{ what results come from your action but if you do nothing there will be no result.}{Mahatma Ghandi}{}
...
\HugeQuote{MA_CREDIT}{Do what nature demands}{. Get a move on if you have it in you and don't worry whether anyone will give you any credit for it.\newline
...
% \smallQuote{LT_EN}{Acts and expects nothing,\newline
% accomplishes and does not linger\newline
% has no desire to seem worthy.}{Lao Tzu}{HT_CREDIT}

\cleartorightpage
\HugeQuote{LT_CREDIT}{When no credit is taken}{,\newline
acomplishment endures.}{Lao Tzu}{HT_CREDIT}
...
\HugeQuote{SZ_LESSON}{History is a great instruction manual}{, for it is in his actions that a man reveales himself.}{Stefan Zwieg}{}{}
...
\smallQuote{MA_INACTION}{If it is not right, do not do it. If it is not true, do not say it.}{Marcus Aurelius}{} 
